    ...
    <footer className="border-t border-stone-200 bg-white mt-20">
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          ...
          <nav className="flex flex-col sm:flex-row gap-4 sm:gap-6 text-sm items-start sm:items-center">
            ...
            {/* Changed: Social links as icon buttons with SVG icons */}
            <div className="flex items-center gap-3">
              <a
                href="https://x.com"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-stone-100 text-stone-600 hover:bg-indigo-600 hover:text-white transition-colors duration-200"
